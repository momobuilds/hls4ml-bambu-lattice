...
set outputDir final_reports
set reportBase ${project_name}_report

proc dump_statistics { outputDir reportBase } {
  set reportXml [file join $outputDir ${reportBase}.xml]
  set reportJson [file join $outputDir ${reportBase}.json]
  ...
  puts $ofile_json "    \"XILINX_DESIGN_DELAY\": \"$design_delay\""
  puts $ofile_json "  \}"
  puts $ofile_json "\}"
  flush $ofile_json
  close $ofile_json
